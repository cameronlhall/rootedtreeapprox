%% runSirGillespieModel.m
%
% Script M-file for running Gillespie simulations of SIR models in case
...
% given number of Gillespie simulations as probS, probI, probR.
%
...
% Standard initial conditions where middle node is infected and all others
% are susceptible.
s0 = ones(numNodes,1);
s0(1) = 0;
i0 = zeros(numNodes,1);
...
% NOTE TO SELF: Should add some error checking to make sure that illegal
% initial conditions can't be given. Error checking should also be in
% sirHybridModel and sirGillespie.
