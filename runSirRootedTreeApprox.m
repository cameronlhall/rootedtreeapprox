%% runHybridModel.m
%
% Script M-file for running solving differential equations of SIR rooted
% tree approximation in case where parameters are constant (same at every
% node/edge). By editing the parameters in this script, you can get an
% output of the solution of the DEs as ssol, isol, and rsol.
%
...
% Standard initial conditions where first node is infected and all others
% are susceptible.
s0 = ones(numNodes,1);
s0(1) = 0;
i0 = zeros(numNodes,1);
